      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>QUALITY ANALYS, ByteDance</h3>
              <p>Attending client calibration sessions regarding policy proposals, policy updates. 
                Auditing process quality and providing the feedback to moderators to keep it candid and clear.
              Doing root cause data analysis and summarizing it on weekly basis.</p>
            </div>
            <footer> <ul className="tech-list"><li>2019 - Present</li></ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>CLEARANCE CHIEF SUPPORTIVE ADMIN, FedEx Airlines</h3>
              <p>
                Worked as a site engineer, dealing with all the workers and maintaining project. I was involved in checking the quality of the work and managing the same.

              </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>07/2017 - 02/2019</li>
              </ul>
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>SITE ENGINEER, KVR Constructions</h3>
              <p>Worked as a site engineer, dealing with all the workers and maintaining project. I was involved in checking the quality of the work and managing the same.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>06/2016 – 03/2017</li>
              </ul>
            </footer>
          </div>
        </ScrollAnimation>
